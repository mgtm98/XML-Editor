...
SQLite::SQLite(QString connName):SQLite(connName, ""){}
SQLite::SQLite(QString connName, QString path){
    this->connName = connName;
    db = QSqlDatabase::addDatabase("QSQLITE", connName);
    this->path = path;
}

bool SQLite::open(QString path){
...
int SQLite::sql_create(QString table, QStringList columns, QStringList types){
...
int SQLite::sql_select(QString select, QString from, QString where){
...
int SQLite::sql_insert(QString table, QStringList columns, QStringList values){
...
int SQLite::sql_update(QString table, QStringList columns, QStringList values, QString where){
...
int SQLite::sql_delete(QString table, QString where){
...
QSqlQuery SQLite::sql_getQuery(){
    return query;
}


int SQLite::sql_close(){
    db.close();
